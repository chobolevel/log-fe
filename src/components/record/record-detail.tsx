...
export function RecordDetail({ id }: RecordDetailProps) {
  ...
  return (
    <>
      {/* 플로팅 액션 패널 */}
      <div className="fixed top-1/3 right-4 z-10 -translate-y-1/2 xl:right-6">
      ...
      <article className="mx-auto w-full max-w-3xl px-4 py-6 md:px-6 md:py-10">
        ...
        <div className="mb-4">
          ...
          <h1 className="text-2xl leading-snug font-black tracking-tight md:text-3xl">
            {title}
          </h1>
        </div>
        ...
        <div className="mb-8 flex items-center gap-3 border-b border-border/60 pb-6">
          ...
          {isAuthor && (
            <div className="ml-auto flex items-center gap-1.5">
              ...
              <AlertDialog>
                <AlertDialogTrigger className="inline-flex h-8 cursor-pointer items-center gap-1.5 rounded-full px-3 text-xs font-medium text-destructive transition-colors hover:bg-destructive/10">
